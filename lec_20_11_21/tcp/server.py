...
socket.bind(("",port)) #ip + port -> socket
socket.listen(1) #listen for 1 tcp connection from client
print("Welcome to the server")


'''
socket.accept() -returns-> (conn,address) accept client tcp connection : where conn is the new socket object usable to send and recieve data on the connection

address is the ip address of the clinet'''
