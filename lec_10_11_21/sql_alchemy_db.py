...
-it is a popular sql toolkit and an ORM ,written in pythonM
...
student_table = Table(
    ...
    Column('id',Integer,primary_key=True), #create cols
    Column('name',String),
...
#rows id>2
stmnt = student_table.select().where(student_table.c.id > 2) #c->indicates we are trying to refer to column of the table
